package com.jason.gaofangmeitu.omshiroi.filter.base;
...
public class FBO {
    ...
    public static FBO newInstance(){return new FBO();}
    ...
    public void bind(){GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, frameBuffer);}
